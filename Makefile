...
# (`exec /bin/sh` -> ls, cat, head, wc, cp, mv, ln, grep, touch, mkdir,
# rm and a nested sh all resolve instead of printing
# "sh: /bin/ls: cannot execute").
DEFAULT_USERLAND = ls cat head cp mv ln grep touch wc mkdir rm sh
